 ...
 * @namespace RTDQ
 *
 * @brief Namespace for \f$H(\mathrm{div})\f$-\f$L^2\f$ problems with conformal multiscale elements.
 */
namespace RTDQ
{
  ...
  public:
    ...
    /*!
     * Solve standard mixed problem with Raviart-Thomas-discontinuous Lagrange
     * element pairing.
     */
    void
      run();
